...
export class ClassesController {
  ...
  programs(@CurrentUser() u: AuthenticatedUser, @Query() q: ListClassesDto) {
    return this.classes.programs(u.organizationId!, q);
  }
  @Post('programs')
  ...
  createProgram(
    ...
    return this.classes.createProgram(u.organizationId!, dto);
  }
  @Get('sessions')
  @RequirePermissions('classes.read')
  sessions(
    ...
    return this.classes.sessions(u.organizationId!, q);
  }
  @Post('sessions')
  @RequirePermissions('classes.manage')
  createSession(
    ...
    return this.classes.createSession(u.organizationId!, dto);
  }
  ...
  cancel(@CurrentUser() u: AuthenticatedUser, @Param('id') id: string) {
    return this.classes.cancel(u.organizationId!, id);
  }
  ...
  attendance(
    ...
    return this.classes.attendance(u.organizationId!, id, dto.status);
  }
  @Get('analytics')
  @RequirePermissions('classes.read')
  analytics(
    ...
    return this.classes.analytics(u.organizationId!, from, to, branchId);
  }
}
