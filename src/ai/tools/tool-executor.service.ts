...
export class ToolExecutorService {
  ...
  private async getDailyBriefing(
    ...
    return this.dailyBriefingService.getBriefing(organizationId, branchScope);
  }
  private async proposeAssignWorkoutPlan(
    ...
    return this.aiActionsService.proposeAssignWorkoutPlan(
      context.organizationId,
      context.userId,
      payload,
    );
  ...
  private async proposeAssignDietPlan(
    ...
    const payload = validateToolArgs(AssignPlanPayloadDto, rawArgs);
    return this.aiActionsService.proposeAssignDietPlan(
      context.organizationId,
      context.userId,
      payload,
    );
